...
// Loop Function waiting for files
func main() {
...
// Check GitHub for new releases on main branch
func checkUpdates() {
...
// Parse user inputs and clean for use in program
...
// Checks for new files and sends files to processFile
...
func processFile(config Config, file string) {
	...
	for retriesRemaining > 0 {
		...
		if err != nil {
            ...
            time.Sleep(time.Millisecond * repeatDelay)
